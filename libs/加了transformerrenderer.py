...
from .ji_transformer import transformer_module
...
class Renderer(nn.Module):
    ...
    def evaluate_field(
        ...
        if z_vol is not None:
            ...
            print("z_vol is")
            print(z_vol.shape)
            # 在这里加入我们的模块，这里写了两个，一个是简单的注意力机制，还有一个是transformer的
            #transformed_z_vol = CBAM_module(z_vol)
            transformed_z_vol = transformer_module(z_vol)
            print("transformed_z is")
