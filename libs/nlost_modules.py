...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, dim_t, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        print("class WindowAttention 中的window size1为{}".format(window_size))
        self.window_size = to_2tuple(window_size * int(np.sqrt(dim_t)))  # Wh, Ww
        print("class WindowAttention 中的window size为{}".format(self.window_size))
        self.num_heads = num_heads
...
class WindowEncoderSep(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads=8, window_size=8, mlp_ratio=4., 
        ...
        print("主模块中的window size 为{}".format(np.sqrt(self.input_resolution[2])))
        print("主模块中的input_resolution[2] 为{}".format((self.input_resolution[2])))
    ...
    def forward(self, inputs):
        ...
        print("x_windows_t的形状为{}".format(x_windows_t.shape))
